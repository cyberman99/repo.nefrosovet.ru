...
// WithGUID adds the guid to the get search params
func (o *GetSearchParams) WithGUID(guid string) *GetSearchParams {
	o.SetGUID(guid)
	return o
}

// SetGUID adds the guid to the get search params
func (o *GetSearchParams) SetGUID(guid string) {
	o.GUID = guid
}
...
func (o *GetSearchParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	qGUID := qrGUID
	if qGUID != "" {
		if err := r.SetQueryParam("GUID", qGUID); err != nil {
			return err
		}
	}
