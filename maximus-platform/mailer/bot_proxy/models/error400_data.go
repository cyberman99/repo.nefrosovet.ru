...
func (m *Error400Data) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 Error400DataAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.Error400DataAllOf1 = aO1
...
func (m Error400Data) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.Error400DataAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *Error400Data) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with Error400DataAllOf1
	if err := m.Error400DataAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
