...
func (tx *Tx) Client() *Client {
	return &Client{
		...
		AccountKey:  NewAccountKeyClient(tx.config),
		Subscriber:  NewSubscriberClient(tx.config),
		User:        NewUserClient(tx.config),
		UserAccount: NewUserAccountClient(tx.config),
		WebinarUser: NewWebinarUserClient(tx.config),
	}
}
...
// applies a query, for example: AccountKey.QueryXXX(), the query will be executed
